...
pub async fn run_migrations(pool: &PgPool) -> Result<(), sqlx::Error> {
    ...
    // Criar tabela users (primeiro, pois outras tabelas dependem dela)
    sqlx::query(
        r#"
    ...
    // Criar tabela stories (usando 'username' em vez de 'user' para evitar palavra reservada)
    sqlx::query(
        r#"
